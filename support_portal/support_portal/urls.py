...
urlpatterns = [
    ...
    path('companyInfoSave', views.companyInfoSave, name='companyInfoSave'),
    path('UserRegForm', views.UserRegForm, name='UserRegForm'),
    path('UserRegSave', views.UserRegSave, name='UserRegSave'),
    path('CreateGroup', views.CreateGroup, name='CreateGroup'),
    path('CreateGroupSave', views.CreateGroupSave, name='CreateGroupSave'),
    path('GroupEdit', views.GroupEdit, name='GroupEdit'),
    path('GroupEditSave', views.GroupEditSave, name='GroupEditSave'),
    path('GroupDelete', views.GroupDelete, name='GroupDelete'),
    path('UserAssignToTeam', views.UserAssignToTeam, name='UserAssignToTeam'),
    path('UserAssignToTeamName', views.UserAssignToTeamName, name='UserAssignToTeamName'),
    ...
    path('CompanyCreatePage', views.CompanyCreatePage, name='CompanyCreatePage'),
    path('copy_userCreate', views.copy_userCreate, name='copy_userCreate'),
    path('userRegistration', views.userRegistration, name='userRegistration'),
    path('AssignedTask', views.AssignedTask, name='AssignedTask'),
    path('OwnTask', views.OwnTask, name='OwnTask'),
    path('profileEdit', views.profileEdit, name='profileEdit'),
    path('profileUpdate', views.profileUpdate, name='profileUpdate'),
    path('importLink', views.importLink, name='importLink'),
